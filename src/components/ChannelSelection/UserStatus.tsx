  ...
  <div className="h-[52px] w-full bg-neutral-900 px-2">
    <div className="flex h-full items-center justify-center">
      <div className="flex h-full flex-1 items-center py-1 pr-2">
        <div className="group flex h-full flex-1 items-center rounded-md hover:bg-zinc-700">
          ...
          <div className="ml-2 flex h-full flex-1 flex-col">
            <div className="flex h-1/2 text-xs items-end">
              <div className="capitalize">{user.name}</div>
            </div>
            <div className="text-2xs flex-flex-col group h-1/2 flex-wrap overflow-hidden transition-all">
