...
export const UserStatus = (): JSX.Element => (
  <div className="h-[52px] w-full bg-neutral-900 px-2">
    <div className="flex h-full items-center justify-center">
      <div className="flex h-full flex-1 items-center py-1 pr-2">
        <div className="group flex h-full flex-1 cursor-pointer items-center rounded-md hover:bg-zinc-700">
          ...
          <div className="ml-2 flex h-full flex-1 flex-col">
            ...
            <div className="flex-flex-col group h-1/2 flex-wrap overflow-hidden text-2xs text-gray-400 transition-all">
      ...
      <div className="group/settings relative flex h-8 w-8 cursor-pointer items-center justify-center rounded-md hover:bg-zinc-700">
        <svg
        ...
        <div className="absolute -top-10 hidden w-24 rounded-sm bg-black p-2 text-xs group-hover/settings:block">
          User Settings
        </div>
      </div>
    </div>
